      ...
      <section className="py-16">
        <div className="container px-4 md:px-6 max-w-7xl mx-auto">
          <Tabs defaultValue="llm" className="w-full pt-4 sm:pt-16">
            <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3 mb-8 sm:mb-20">
            ...
            <TabsContent value="llm" className="space-y-12 mt-0 sm:mt-20">
            ...
            <TabsContent value="moe" className="space-y-12 mt-0 sm:mt-20">
              <div className="grid gap-8 lg:grid-cols-2 items-center">
                <div>
            ...
            <TabsContent value="ke" className="space-y-12 mt-0 sm:mt-20">
              <div className="grid gap-8 lg:grid-cols-2 items-center">
                <div>
